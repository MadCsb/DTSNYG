...
var Alert={	  
	...
	showMsg:function(obj){
		var subhtml='<div id="alert_dialog_show_msg_box" style=" overflow:hidden;height:100px;width:200px;margin:15% auto; position: "><div class="sweet-overlay" tabIndex="-1" style=" background-color:#000; opacity:0.8; position: fixed; left: 0; right: 0; top: 0; bottom: 0; z-index:1000;"></div><div id="alert_show_3" style="height:100px; width:200px; background-color:#fff; color:#000; border-radius:8px;font-size:20px; text-align:center;z-index:2000;position:absolute;"><p style="font-size:14px; margin-top:20px; height:50px;">'+obj+'</p><input name="button" onclick="closedShowMsg()" type="button" value="确认" style=" border:0;width:50%; height:40px; line-height:36px;border-top:1px solid #eeeeee; border-radius:0 0 0 5px;"  /><input name="button" onclick="closedShowMsg()" type="button" value="取消" style=" border:0;width:50%; height:40px; line-height:36px;border-top:1px solid #eeeeee; border-left:1px solid #eee; border-radius:0 5px 0  0;"  /></div></div>';
		$("body").append(subhtml);
	},
