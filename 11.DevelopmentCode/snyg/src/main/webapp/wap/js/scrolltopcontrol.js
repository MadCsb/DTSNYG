var scrolltotop={
	setting:{
		...
		fadeduration:[200,100] //淡出淡现消失
	},
	controlHTML:'<img src="wx/images/topback.png" style="width:54px; height:54px; border:0;" />', //返回顶部按钮
	controlattrs:{offsetx:10,offsety:55},//返回按钮固定位置
	anchorkeyword:"#top",
	state:{
		isvisible:false,
		shouldvisible:false
