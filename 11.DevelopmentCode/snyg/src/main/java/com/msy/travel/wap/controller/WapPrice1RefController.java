...
@RequestMapping(value = "/wapPrice1Ref")
public class WapPrice1RefController extends BaseController {
	public static final Log log = LogFactory.getLog(WapPrice1RefController.class);
	...
	public ModelAndView querySellPriceListForWx(Price1Ref price1Ref, HttpServletRequest request, HttpServletResponse response) {
