 ...
 * under the License.
 *
 * @Title: locationMsgHandler.java 
 * @Package com.wootide.travel.weixin.service 
 * @Description: TODO(用一句话描述该文件做什么) 
 * @author WangHuan  
 * @date 2014-4-2 下午02:22:57 
 * @version V1.0   
 */
...
@Service
@Transactional
public class LocationMsgHandler extends AbstractMsgHandler {
	private static final Log log = LogFactory.getLog(LocationMsgHandler.class);
