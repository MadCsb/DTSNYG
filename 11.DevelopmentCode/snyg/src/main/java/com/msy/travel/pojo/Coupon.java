...
public class Coupon extends BaseEntity implements java.io.Serializable
{
    ...
    public static final String[] EXPORT_HEADERS ={
         //columns START
          ...
          "name:优惠券名称"
          ,
          "optainType:获取方式:1商品页领取；2活动页领取"
          ,
          "totalNum:发行总量"
          ,
          "dayNum:日发行量"
          ,
          "userType:使用类型:1满减，2折扣"
          ,
          "useLimit:使用限制：满XXXX元"
          ,
          "discount:折扣优惠"
          ,
          "obtainLimit:每人限领"
          ,
          "dayObtainLimit:每人每天限领"
          ,
          "validBegin:有效开始日期"
          ,
          "validEnd:有效结束日期"
          ,
          "obtainDateType:领券日期类型：1有效时段，2有效时长"
          ,
          "obtainDateBegin:领券开始日期"
          ,
          "obtainDateEnd:领券结束日期"
          ,
          "obtainDateSpan:领券结束时长"
          ,
          "couponType:优惠类型:1全部商品，2指定商品"
          ,
          "status:状态:1"
          ,
          "createTime:创建时间"
