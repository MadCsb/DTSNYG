...
@RequestMapping(value = "/webPrice1Ref")
public class WebPrice1RefController extends BaseController {
	public static final Log log = LogFactory.getLog(WebPrice1RefController.class);
