...
import com.msy.travel.common.wx.MD5Util;
import com.msy.travel.common.wx.MyX509TrustManager;
...
public class WxPayUtil {
	 ...
	 * 微信关闭订单URL
	 */
	public static String WX_CLOSEORDER_URL = "https://api.mch.weixin.qq.com/pay/closeorder";
	/**
     * 微信发红包URL
     */
	...
	* @throws
	 */
	public static String sslHttpRequest(String requestUrl,
        String requestMethod, String outputStr,String caPath,String caPwd)
    {
	  ...
	  try
      {
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, caPwd.toCharArray())
                .build();
	...
	public static String httpRequest(String requestUrl,
		...
		public static String createSign(Map<String, String> paramMap , String key){
			...
			for(String paramName: paramNameList)
			{
        	 ...
        	 log.error("微信支付 params:"+parmaStr.toString());
		...
		public static Map<String,String> getPayNotifyResult(InputStream inputStream) throws DocumentException
		{
            ...
            for (int i = 0; i < xlist.size(); i++)
            {
                ...
                log.error(element.getName()+"="+element.getText());
		...
		public static String getQrcodePreCode(Map<String,String> paramMap)
	    {
	    		try
	            {
	                	 ...
	                	 paramMap.put("notify_url", new ConfigParameter().getWxpayNotifyUrl());
	                	 //生成签名
...
//			System.out.println(WxPayUtil.httpRequest("https://api.mch.weixin.qq.com/pay/unifiedorder", "POST", xml));
